        ...
        <section class="flex-1 flex flex-col justify-between p-6 sm:p-12 lg:p-16 relative z-10">
            ...
            <div class="flex-1 flex items-center justify-center my-auto">
                <div class="bg-slate-900/30 backdrop-blur-md border border-slate-800/60 p-8 sm:p-10 rounded-2xl w-full max-w-md shadow-2xl relative">
                    ...
                    <button
                        type="button"
                        class="w-full bg-slate-950/60 border border-slate-800/80 rounded-xl py-3.5 px-4 flex items-center justify-center gap-3 hover:bg-slate-900 transition-all duration-350 text-white text-xs font-bold uppercase tracking-wider cursor-pointer shadow-sm hover:border-slate-700"
                    >
